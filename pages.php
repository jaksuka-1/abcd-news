...
$handle3 = curl_init();
$url = "https://app.gethellonews.com/site/page.php";
			...
			<div class="row">
				<div class="col-md-8">
					<div class="blog-single">
						<img src="<?php echo $json3['pages']['pageimg'];?>" class="img-responsive" alt=""/>
						<h3 class="h1"><?php echo $json3['pages']['pagename'];?></h3>
